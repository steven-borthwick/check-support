...
router.get('/results_confirm2', function (req, res) {
  ...
  res.render('volnicsv21/results_confirm2', {
...
router.get('/issue_address_customer', function (req, res) {
  ...
  if (thirdparties === 'Third party') {
    ...
    res.render('volnicsv21/issue_address_customer')
  }
...
router.post('/forecast_QQ123456C', function (req, res) {
  ...
  console.log(age);
  console.log(month);
  res.render('volnicsv21/forecast_QQ123456C', {age: age, years: years, month: month,}) 
});
