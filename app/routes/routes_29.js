...
router.get('/results_confirm2', function (req, res) {
  ...
  res.render('volnicsv19/results_confirm2', {
...
router.get('/issue_address_customer', function (req, res) {
  ...
  if (thirdparties === 'Third party') {
    ...
    res.render('volnicsv19/issue_address_customer')
  }
...
router.post('/forecast_QQ123456C', function (req, res) {
  ...
  console.log(age);
  console.log(month);
  res.render('volnicsv19/forecast_QQ123456C', {age: age, years: years, month: month,}) 
});
...
router.post('/forecast_DD678910C', function (req, res) {
  ...
  console.log(years);
  console.log(age);
  res.render('volnicsv19/forecast_DD678910C', {age: age, years: years})
});
